...
Bureaucrat::GradeTooLowException::GradeTooLowException(const std::string &message) throw() : 
GradeException("(Bureaucrat) grade too low : " + message) {}
Bureaucrat::GradeTooLowException::~GradeTooLowException() throw(){}

Bureaucrat::GradeTooHighException::GradeTooHighException(const std::string &message) throw() : GradeException("(Bureaucrat) grade too high : " + message) {}
...
AForm::gradeTooLowException::gradeTooLowException(const std::string &message) throw() : GradeException("(AForm)grade too low : " + message) {}
AForm::gradeTooLowException::~gradeTooLowException() throw(){}

AForm::gradeTooHighException::gradeTooHighException(const std::string &message) throw() : GradeException("(AForm)grade too high : " + message) {}
